...
app.controller('CityController', function ($scope, $http, $location, CityService, $rootScope, StudentService, helperService) {
        ...
        $scope.init = function () {
            ...
            StudentService.GetStudenttestDetails($scope.UserName).then(function success(success) {
                ...
                if (success.data != null) {
                    ...
                    console.log("FacultyProgramdetails", $scope.FacultyProgramdetails);
                    $scope.ShowStartButton = true;
                    $scope.ShowQuestions = false;
                    $scope.GetStudentTestQuestions();
                }
                else {
        ...
        $scope.GetStudentTestQuestions = function () {

            //swal({
            //    title: "Are you sure?", text: "You are going to start test.",
            //    type: "warning",
            ...
            //    function () {
            console.log("FacultyProgramdetails");
            StudentService.GetStudentTestQuestions($scope.StudentTestDetails[0].ProgramTestCalenderId).then(function success(success) {
                $scope.StudentTestQuestions = success.data;
                if ($scope.StudentTestQuestions != null) {
                    $scope.QuestionsResponse = $scope.StudentTestQuestions;
                    ...
                    $scope.questions = $scope.config.shuffleQuestions ? helperService.shuffle($scope.StudentTestQuestions) : $scope.StudentTestQuestions;
