...
app.service('FacultyAgencyLevelService', function ($http, $location) {
    ...
    this.SaveTestInitiationDetailsWithAttendance = function (Obj) {
        return $http.post(this.AppUrl + '/Test/SaveTestInitiationDetailsWithAttendance', Obj);
    }; 
        ...
        var CurrentDate = $filter('date')(new Date(), 'dd-MM-yyyy');       
            ...
            {               
                angular.forEach($scope.SelectedSessionIds, function (value,Key) {
                    ...
                    if (CurrentDate == TestIntiateDate) {
...
app.controller('InitiateTestController', function ($scope, $rootScope, FacultyAgencyLevelService, $uibModalInstance, InitFactory) {
