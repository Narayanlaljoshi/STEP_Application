...
app.controller('StudentController', function ($scope, $http, $location, $cookies, StudentService, helperService, $rootScope) {
    $scope.dirOptions = {};
    ...
    return {
        ...
        link: function (scope, elem, attrs) {
            ...
            function tick() {
                ...
                //console.log('minutes after modula by 60 ', scope.minutes);

                //scope.hours = Math.floor(((scope.millis / (1000 * 60 * 60)) % 24));
                //scope.days = Math.floor(((scope.millis / (1000 * 60 * 60)) / 24));
                //if (scope.minutes == 0 && scope.seconds == 0) {
                //    StudentService.SaveTestResponse(StudentService.StudentTestQuestions).then(function success(success) {
                //        //window.location = './Stlogin.html';
                //    }, function error(Error) {
                //        //console.log("Error in loading data from EDB");
                //    });
