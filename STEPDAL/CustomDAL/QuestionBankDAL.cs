    ...
    public class QuestionBankDAL
    {
        ...
        public static string UploadList_Practical(DataTable dt, ProgramTestModel obj)
        {
            ...
            using (var context = new CEIDBEntities())
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    int TempQues_Sequence;
                    //Ques_Sequence = dr["Sno."].ToString();
                    try
                    {
                        if (Int32.TryParse(dr["Sno."].ToString(), out TempQues_Sequence))
                        {
                            Ques_Sequence = TempQues_Sequence;
                        }
                    }
                    catch (Exception ex) { }
                    try
                ...
                if (index == -1)
                {
                    foreach (var row in List)
                    {
                        ...
                        if (Check != null)
                        {
                            ...
                            Check.TestDuration = obj.TestDuration;
                            Check.Ques_Sequence = row.Ques_Sequence;
                        ...
                        else
                        {
                            ...
                            {
                                ProgramTestCalenderId = obj.ProgramTestCalenderId,
                                Ques_Sequence=row.Ques_Sequence,
        ...
        public static List<Practical_QuestionDetail> GetPracticalQuestionBankList(FilterBLL Obj)
        {
            using (var context = new CEIDBEntities())
            {
                ...
                objList.OrderBy(x => x.Ques_Sequence).ToList();
                return objList;
