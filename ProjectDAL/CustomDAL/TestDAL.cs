...
namespace ProjectDAL.CustomDAL
{
    public class TestDAL
    {
        ...
        public static StudentTestResponse_Practical GetStudentQuestionFormatedList_Practical(QuestionVariable data)
        {
            string SessionId = data.SessionID;
        ...
        public static string SaveCompleteTestResponse_Practical(StudentTestResponse_Practical Object)
        {
            string Msg = string.Empty;
            using (var context = new CEIDBEntities())
            {
                foreach (var Obj in Object.StudentLanguageQuestion) {
                ...
                try
                {
                    ...
                    TestDAL.LogService("SP_Insert_Update_TblStudentAnswerHdr Status: - " + Status);
                    int StatusDtl = context.SP_Insert_Update_TblStudentAnswer_Practical(Obj.SA_Id, Obj.ProgramTestCalenderId, Obj.ProgramId, Obj.MSPIN, Obj.QuestionCode, Obj.Day, Obj.SessionID, Obj.TypeOfTest, Obj.SA_ActionA, Obj.SA_ActionB, Obj.SA_ActionC, Obj.SA_ActionD, Obj.SA_ActionE, null, Obj.ActionTaken == "a"? Obj.Marks_A : null, Obj.ActionTaken == "b" ? Obj.Marks_B : null, Obj.ActionTaken == "c" ? Obj.Marks_C : null, Obj.ActionTaken == "d" ? Obj.Marks_D : null, Obj.ActionTaken == "e" ? Obj.Marks_E : null, Obj.ActionTaken == "f"?Obj.Marks_F:null, true);
                    if (Obj.Status_Id == 1)
                    {
                        context.sp_UpdateTblTestDtl_Evaluation(Obj.MSPIN, Obj.SessionID, Obj.Day);
                    }
        ...
        public static string InitiateTestForEvaluation_Practical(EligibleCandidatesForEvaluation Obj)
        {
            using (var Context = new CEIDBEntities())
            {
                ...
                var check = Context.TblTestDtl_Evaluation.Where(x => x.MSPIN == Obj.MSPIN && x.Day == Obj.Day && x.SessionID == Obj.SessionID && x.IsActive == true).FirstOrDefault();
                if (check == null)
                {
                    TblTestDtl_Evaluation DT = new TblTestDtl_Evaluation
                    {
