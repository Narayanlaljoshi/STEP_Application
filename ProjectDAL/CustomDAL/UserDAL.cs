    ...
    public class UserDAL
    {
        ...
        public static int AuthUser(string userName)
        {
            ...
            using (var Context = new CEIDBEntities())
            {
                ...
                if (GetDeatils.Role_Id == 1 || GetDeatils.Role_Id == 2)
                {
                    ...
                    string Body = "Your password has been reset. Login credentails are as follows:<br /> <br />" + "\r\n" + "\r\n" + "Username : " + GetDeatils.UserName + "\r\n" + ",<br /> Password : " + GetDeatils.Password;
                    string frmEmail = "narayan.joshi@phoenixtech.consulting";
                    string toEmail = GetDeatils.Email;
                    string ccEmail = "";
                    if (toEmail != null)
                    {
                        string str = Email.sendEmailReport(frmEmail, toEmail, ccEmail, subject, Body);
