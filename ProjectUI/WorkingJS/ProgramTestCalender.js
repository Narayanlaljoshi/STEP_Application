...
app.controller('ProgramTestCalenderController', function ($scope, $http, $location, ProgramTestCalenderService, ProgramMasterService,$rootScope) {
    ...
    $scope.init = function () {
        ...
        if (!(ProgramMasterService.ProgramDeatil)) {
            ...
            $scope.ProgramType_Id = ProgramMasterService.ProgramDeatil.ProgramType_Id;
    ...
    $scope.AddProgramTestCalender = function () {
        ...
        if (ProgramMasterService.ProgramDeatil.ProgramType_Id == 2 || ProgramMasterService.ProgramDeatil.ProgramType_Id == 3) {
            console.log(ProgramMasterService.ProgramDeatil);
    ...
    $scope.AddSaveProgramTestCalender = function () {
        ...
        angular.forEach($scope.ProgramTestCalenderDetailData, function (value, key) {
            ...
            console.log(value);
            if (!value.DayCount || !value.TestCode || !value.EvaluationTypeId || !value.TypeOfTest  || !value.TestDuration || !value.ValidDuration || (!value.Marks_Question && value.EvaluationTypeId == 1)) {
                console.log(value);
