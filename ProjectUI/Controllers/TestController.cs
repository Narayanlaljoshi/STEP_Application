...
namespace Project.Controllers
{
    public class TestController : ApiController
    {
        ...
        //}
        [HttpPost]
        public StudentTestResponse_PracticalV2 GetStudentQuestionFormatedList_Practical(QuestionVariable data)
        {
            //if (data.EvaluationType_Id==2)
            //{
            //    TestDAL.UpdateTestTimeForPractical(data);
            //}
            return TestDAL.GetStudentQuestionFormatedList_Practical(data);
        }
        [HttpPost]
        ...
        [HttpPost]
        public string SaveCompleteTestResponse_Practical(StudentTestResponse_PracticalV2 Object)
        {
            return TestDAL.SaveCompleteTestResponse_Practical(Object);
        }

        [HttpGet]
        public List<SetSequenceForProgramTestCalenderId> GetSetSequenceByProgramTestCalanderId(int Id)
        {
            return TestDAL.GetSetSequenceByProgramTestCalanderId(Id);
        }
        ...
        [HttpPost]
        public string ClosePracticalSession(List<SessionIDListBLL> Obj)
        {
            return TestDAL.ClosePracticalSession(Obj);
        }
    }
}